...
@section('pre-content')
    <div class="fle-col mt-[4rem] flex h-fit w-full items-center justify-center rounded-bl-[5rem] bg-slate-100 px-[1rem] pb-[1rem] shadow-sm shadow-slate-500 dark:bg-inherit dark:text-inherit md:flex-row md:px-[18%] md:text-xl lg:rounded-bl-[17rem] lg:pb-[0rem] lg:pr-0 lg:pt-[1rem]"
        id="home-banner-content">
        <div class="flex h-full w-full flex-col items-center px-[20%] pb-4 lg:w-[50%] lg:px-[5%] lg:py-0" id="home-banner-content-left">
            <h1 class="text-center text-4xl font-black text-gray-700 dark:bg-inherit dark:text-inherit lg:text-left lg:text-7xl lg:text-[5xl]">
                Bem vindo ao <span class="font-black text-emerald-800 dark:text-emerald-400">IBFE</span>
            </h1>
            <p class="text-md mb-[2.7rem] mt-[1.25rem] text-center font-normal text-gray-800 dark:bg-inherit dark:text-inherit lg:my-8 lg:text-left lg:text-xl lg:text-[lg]">
                O ponto de partida para seu sucesso profissional.
            </p>
            <a class="text-md flex w-fit flex-row items-center justify-center rounded-lg bg-black px-3 py-1 font-semibold text-white transition hover:bg-transparent hover:text-black hover:outline hover:outline-2 hover:outline-black md:px-4 md:py-3 md:text-2xl"
                href="#">
                <span>Faça seu teste agora</span>
                <span class="material-icons ml-2 text-emerald-500">arrow_forward</span>
            </a>
            {{-- <div class="hidden lg:flex w-full h-3 bg-black flex-grow"></div> --}}
        </div>
...
@section('content')
    ...
    <div class="text-content flex w-full flex-col text-justify text-sm md:text-lg">
        <h1 class="mb-3 font-serif text-2xl font-black uppercase text-slate-800 md:mb-4 md:text-3xl lg:text-4xl">Sobre Nós</h1>
        <br>
    ...
    <div class="ie-caroussel my-[3rem] flex h-fit w-full select-none flex-col dark:bg-inherit dark:text-inherit items-center justify-center md:mb-[5rem] md:mt-[7rem] md:text-lg" data-ie-caroussel-switch-time="15000">
        @for ($i = 0; $i < 3; $i++)
            <div class="ie-item my-[1rem] flex w-[29%] flex-col items-center dark:bg-inherit dark:text-inherit bg-white py-1 text-center">
                <h4 class="mb-4 uppercase font-serif text-base font-bold md:text-2xl lg:text-4xl">Lorem</h4>
                <p class="mb-2 text-sm md:text-xl lg:text-2xl">Lorem ipsum dolor, sit amet consectetur adipisicing elit [{{ $i }}].</p>
                <div class="flex h-fit w-full flex-row flex-nowrap items-center justify-center p-0 text-xs transition-colors dark:hover:text-emerald-400 hover:text-sky-700">
                    <a class="font-bold text-xs md:text-lg" href="#">ler mais</a>
    ...
    <div class="mb-[3rem] flex h-fit w-full flex-col rounded-lg dark:bg-emerald-600 bg-[#0D652D88] px-[20%] py-[5%] lg:mb-[5rem] md:px-[10%]">
    ...
    <div class="flex w-full flex-col items-center justify-center rounded-3xl bg-black px-7 py-[2rem] text-center text-white md:text-xl">
