    ...
    <div class="flex flex-row">
        <div class="flex max-w-[33%] flex-grow flex-col md:max-w-[25%]">
            ...
            <ul class="mt-2 flex flex-grow list-none flex-row flex-wrap justify-evenly">
                <li><img alt="Logotipo do Facebook" class="w-[1.5rem]"
                         src="https://www.svgrepo.com/show/424922/facebook-logo-meta-2.svg"></li>
                <li><img alt="Logotipo do linkedin" class="w-[1.5rem]"
                         src="https://www.svgrepo.com/show/447416/linkedin.svg"></li>
                <li><img alt="Logotipo do twitter" class="w-[1.5rem]"
                         src="https://www.svgrepo.com/show/364957/twitter-logo-fill.svg"></li>
                <li><img alt="Logotipo do Instagram" class="w-[1.5rem]"
                         src="https://www.svgrepo.com/show/424911/instagram-logo-facebook-2.svg"></li>
            </ul>
        </div>
