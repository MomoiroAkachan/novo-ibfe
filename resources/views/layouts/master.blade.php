...
<body class="dark:bg-slate-800 dark:text-slate-300">
    <div class="h-full w-full" id="ie-theme-config">
        ...
        {{-- Rodapé --}}
        <footer class="mb-4 flex h-fit w-full flex-row justify-between px-[10%] text-sm md:px-[8%] md:text-base lg:px-[14%]">
            <div class="flex max-w-[33%] md:max-w-[25%] flex-grow flex-col">
                <p class="text-justify text-xs font-light md:text-sm">
                ...
                <ul class="mt-2 flex justify-evenly flex-grow list-none flex-row flex-wrap">
            ...
            <div class="flex flex-grow flex-col mx-[5%]">
                ...
                <div class="mt-3 flex w-fit flex-1 flex-col">
                    <h5 class="mb-2 font-serif font-semibold">Créditos</h5>
                    <p class="text-xs">
                        <a
